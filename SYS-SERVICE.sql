...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-03-2023 a las 00:36:47
...
CREATE TABLE `casas` (
  ...
  `SDIRECCION` varchar(99) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `clientes` (
  ...
  `SNOMBRE` varchar(99) COLLATE utf8_bin NOT NULL,
  `SAPELLIDO_PAT` varchar(99) COLLATE utf8_bin NOT NULL,
  `SAPELLIDO_MAT` varchar(99) COLLATE utf8_bin NOT NULL,
  `SEMAIL` varchar(99) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `detalle_pago` (
  ...
  `DREGISTRO` varchar(99) COLLATE utf8_bin NOT NULL,
  `SOBSERVACION` varchar(99) COLLATE utf8_bin NOT NULL,
  `MMEDICION` varchar(99) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `parametros_servicios` (
  `NID` int(11) NOT NULL,
  `SLABEL` varchar(99) COLLATE utf8_bin NOT NULL,
  `SVALUE` varchar(250) COLLATE utf8_bin NOT NULL,
  `CTYPE` varchar(1) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `privilegios` (
  `NID` int(11) NOT NULL,
  `SLABEL` varchar(50) COLLATE utf8_bin NOT NULL,
  `SURL` varchar(50) COLLATE utf8_bin NOT NULL,
  `SICON` text COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `urbanizaciones` (
  `NID` int(11) NOT NULL,
  `SURBANIZACION` varchar(99) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `usuario` (
  ...
  `SUSER` varchar(50) COLLATE utf8_bin NOT NULL,
  `SPASSWORD` varchar(250) COLLATE utf8_bin NOT NULL,
  `NPASSWORD_RESET` int(1) NOT NULL DEFAULT 1,
  `SDOCUMENT` varchar(8) COLLATE utf8_bin NOT NULL,
  `SNOMBRE` varchar(100) COLLATE utf8_bin NOT NULL,
  `SAPELLIDO_PAT` varchar(100) COLLATE utf8_bin NOT NULL,
  `SAPELLIDO_MAT` varchar(100) COLLATE utf8_bin NOT NULL,
  `SNUMBER` varchar(9) COLLATE utf8_bin NOT NULL,
  `SDIRECCION` varchar(250) COLLATE utf8_bin NOT NULL,
...
(7, 1, 'aadsasfdsgfdsgfd', '2559755edd4cda058dc6434c5f168d16', 0, '98876546', 'Guillermo', 'AAAA', 'AAAAA', '79879', 'Surco Nuevo', 'ASD@ASD.COM'),
