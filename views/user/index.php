                                    ...
                                    <tr>
                                        ...
                                        ?>
                                                <td class="h5">
                                                    ...
                                                    <?php } else { ?><span class="badge bg-danger">Deshabilitado</span>
                                                    <?php } ?>
                                                </td>
                                            <?php } else { ?>
                                                <td><?php echo ($row[$i]) ?>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo constant("URL") ?>/user/delete?id=<?php echo ($row[5]) ?>" class="btn btn-sm btn-icon text-danger " data-bs-toggle="tooltip" title="Eliminar Usuario">
                                                <span class="btn-inner">
