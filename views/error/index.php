...
<head>
    ...
    <title><?php echo constant("SYS-SHORT") ?> | Error</title>
...
<body class=" " data-bs-spy="scroll" data-bs-target="#elements-section" data-bs-offset="0" tabindex="0">
    ...
    <div class="wrapper">
        ...
        <div class="gradient">
            <div class="container">
                <img src="<?php echo constant("URL") ?>/assets/images/error/404.png" class="img-fluid mb-4 w-50" alt="">
                <h2 class="mb-0 mt-4 text-white">Oops! P&aacute;gina no encontrada</h2>
                <p class="mt-2 text-white">La p&aacute;gina que solicita no existe o esta en mantenimiento.</p>
                <a class="btn bg-white text-primary d-inline-flex align-items-center" href="<?php echo constant("URL") ?>/">Regresar al inicio</a>
            </div>
            <div class="box">
