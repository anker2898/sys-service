                ...
                <div class="col-md-6">
                        ...
                        <div class="col-md-10">
                            <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                                <div class="card-body">
                                    ...
                                    <h2 class="mb-2 text-center">Iniciar Sesi&oacute;n</h2>
                                    <p class="text-center">Ingresa tu usuario y contrase&ntilde;a</p>
                                    <form action="<?php echo constant("URL") ?>/login/auth" method="post">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label for="text" class="form-label">Usuario</label>
                                                    <input type="text" class="form-control" id="email" aria-describedby="email" name="user">
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label for="password" class="form-label">Contrase&ntilde;a</label>
                                                    <input type="password" class="form-control" id="password" aria-describedby="password" name="pass">
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <?php if ($this->mensaje) { ?>
                        <div class="mb-2 text-center ">
                            <p>Usuario y/o contrase&ntilde;a incorrecta.</p>
                        </div>
                    <?php } ?>
                    <div class="sign-bg">
