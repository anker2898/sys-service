                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="datatable" class="table table-striped" data-toggle="data-table">
                            <thead>
                                <tr>
                                    <th style="width: 55%;">Par&aacute;metro</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <!--<a href="<?php //echo constant("URL") 
                                                            ?>/parameter/delete?id=<?php //echo ($row[3]) 
                                                                                    ?>" class="btn btn-sm btn-icon text-danger " data-bs-toggle="tooltip" title="Eliminar Par&aacute;metro">
                                                <span class="btn-inner">
